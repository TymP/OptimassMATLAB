function [D, Q] = findReturnDandQ(P3, T3, power1, power2, flow, P5)
%%%[Density [kg/m^3],Quality] = findDensity(Pressure3 [bar], Temperature 3 [C], Power 1 [W], Power 2 [W], flow [g/s], local pressure [bar] )
%%%Calculates the density of the two phase fluid on the evaporator return
%%%line using the heater power and mass flow rate.
